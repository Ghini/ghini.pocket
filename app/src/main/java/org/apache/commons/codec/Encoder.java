 ...
 * Every implementation of Encoder provides this common generic interface which
 * allows a user to pass a generic Object to any Encoder implementation in the
 * codec package.</p>
 *
